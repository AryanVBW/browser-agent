...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  brouser-agent run "Search for Python tutorials on YouTube"
  brouser-agent run "Book a flight from NYC to LA" --browser firefox
  brouser-agent detect-browsers
  brouser-agent schedule "Check my email" --daily "09:00"
        """
    )
